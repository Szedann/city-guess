...
function App() {
  ...
  const nextCity = ()=>{
    ...
    if(city.names[0] !== 'null island') setPreviousCities([...previousCities, {...city, correct}])
  ...
  return (
    <div className="App">
      ...
      <input type="text" name="cityName" className='cityNameInput' placeholder='City name' value={nameFieldValue} onChange={nameFieldChange} onKeyUp={keyUp}/>
